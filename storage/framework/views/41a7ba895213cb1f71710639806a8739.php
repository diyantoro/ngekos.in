...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
Kos: <?php echo e($namaKos); ?><?php echo e($namaKamar !== '-' ? ' · Kamar '.$namaKamar : ''); ?>

Periode: <?php echo e($tagihan->periode); ?>

Jatuh tempo: <?php echo e($tagihan->jatuh_tempo?->translatedFormat('d F Y') ?? '-'); ?>

Sewa: Rp<?php echo e(number_format($ringkasan['sewa'], 0, ',', '.')); ?>

Denda berjalan (<?php echo e($ringkasan['hari_telat']); ?> hari × Rp<?php echo e(number_format($ringkasan['denda_per_hari'], 0, ',', '.')); ?>/hari): Rp<?php echo e(number_format($ringkasan['denda'], 0, ',', '.')); ?>

**Total yang harus dibayar: Rp<?php echo e(number_format($ringkasan['total'], 0, ',', '.')); ?>**
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPatungan && $porsiSaya !== null): ?>
Porsi kamu (patungan): **Rp<?php echo e(number_format($porsiSaya, 0, ',', '.')); ?>**
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Ngekos.in\resources\views\emails\pengingat-tagihan.blade.php ENDPATH**/ ?>