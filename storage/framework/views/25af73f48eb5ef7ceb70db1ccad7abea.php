        ...
        <div class="min-w-0 lg:col-span-5">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFree && ($bisaKlaim ?? false)): ?>
                <p class="mt-2 max-w-md rounded-xl bg-teal-50 dark:bg-teal-500/10 ring-1 ring-teal-200 dark:ring-teal-500/30 px-3 py-2 text-xs leading-relaxed text-teal-700 dark:text-teal-300">
                    ...
                    <a href="<?php echo e(route('langganan.subscription')); ?>" wire:navigate class="font-bold underline hover:no-underline">Klaim Trial 7 Hari</a>
                </p>
            <?php elseif($isFree && $sisaTrial !== null): ?>
