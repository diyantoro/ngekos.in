...
<div
    x-data="{
        ...
        openModal() {
            ...
            <?php echo e($attributes->has('focusable') ? 'const first = this.firstFocusable(); if (first) { setTimeout(() => first.focus(), 100); }' : ''); ?>
...
>
    ...
    >
        <div class="absolute inset-0 bg-gray-900/50 dark:bg-black/60"></div>
    </div>
    ...
    <div
        ...
        class="mb-6 bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto"
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH C:\laragon\www\Ngekos.in\resources\views\components\modal.blade.php ENDPATH**/ ?>