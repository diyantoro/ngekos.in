...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-414598986-0', $__key);
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'h-8 w-8 transition-transform duration-300 group-hover:scale-110']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-8 w-8 transition-transform duration-300 group-hover:scale-110']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <nav class="hidden sm:flex items-center gap-1">
                            <a href="<?php echo e(route('kos.index')); ?>" wire:navigate
                               class="px-3 py-2 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('kos.*') ? 'text-teal-600 bg-teal-50 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'); ?>">
                                Cari Kos
                            </a>
                            <a href="<?php echo e(route('bantuan')); ?>" wire:navigate
                               class="px-3 py-2 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('bantuan') ? 'text-teal-600 bg-teal-50 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'); ?>">
                                Bantuan
                            </a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                                <?php $unread = auth()->user()->pesanBelumDibaca(); ?>
                                <a href="<?php echo e(route('chat.index')); ?>" wire:navigate
                                   class="relative px-3 py-2 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('chat.*') ? 'text-teal-600 bg-teal-50 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'); ?>">
                                    Pesan
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('pemilik')): ?>
                                    <a href="<?php echo e(route('pemilik.properti')); ?>" wire:navigate
                                       class="px-3 py-2 text-sm font-medium rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('pemilik.properti*') ? 'text-teal-600 bg-teal-50 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'); ?>">
                                        Kelola Kos
                                    </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-200"
                    ...
                    <div class="px-4 py-3 space-y-1">
                        <a href="<?php echo e(route('kos.index')); ?>" wire:navigate @click="open = false"
                           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('kos.*') ? 'text-teal-600 bg-teal-50 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 active:bg-gray-100'); ?>">
                        ...
                        <a href="<?php echo e(route('bantuan')); ?>" wire:navigate @click="open = false"
                           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('bantuan') ? 'text-teal-600 bg-teal-50 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 active:bg-gray-100'); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('chat.index')); ?>" wire:navigate @click="open = false"
                               class="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('chat.*') ? 'text-teal-600 bg-teal-50 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 active:bg-gray-100'); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('pemilik')): ?>
                                <a href="<?php echo e(route('pemilik.properti')); ?>" wire:navigate @click="open = false"
                                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('pemilik.*') ? 'text-teal-600 bg-teal-50 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 active:bg-gray-100'); ?>">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-4">
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div class="flex items-center gap-2">
                            <?php if (isset($component)) { $__componentOriginal8892e718f3d0d7a916180885c6f012e7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8892e718f3d0d7a916180885c6f012e7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'h-6 w-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('application-logo'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php unset($__componentOriginal8892e718f3d0d7a916180885c6f012e7); ?>
<?php endif; ?>
                            <p class="text-sm text-gray-500 dark:text-gray-400">&copy; <?php echo e(date('Y')); ?> <?php echo e(\App\Models\Pengaturan::namaSitus()); ?> &mdash; <?php echo e(\App\Models\Pengaturan::deskripsiSitus()); ?></p>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" wire:navigate class="text-sm font-medium text-teal-600 hover:text-teal-500 transition-colors">Masuk ke dashboard</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('register')); ?>" wire:navigate class="text-sm font-medium text-teal-600 hover:text-teal-500 transition-colors">Daftarkan kos Anda</a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <?php
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($emailKontak || $teleponKontak || $alamatKontak): ?>
                        <p class="text-xs text-gray-400 dark:text-gray-500 text-center sm:text-left">
                            Kontak:
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alamatKontak): ?><span class="ms-1"><?php echo e($alamatKontak); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teleponKontak): ?><span class="ms-1">&bull; <?php echo e($teleponKontak); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($emailKontak): ?><span class="ms-1">&bull; <a href="mailto:<?php echo e($emailKontak); ?>" class="hover:text-teal-600 transition-colors"><?php echo e($emailKontak); ?></a></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </footer>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-414598986-1', $__key);
