...
<div x-data="{ shown: false, timeout: null }"
     ...
     aria-live="polite"
     style="display: none;"
    <?php echo e($attributes->merge(['class' => 'text-sm text-gray-600 dark:text-gray-300'])); ?>>
    <?php echo e($slot->isEmpty() ? __('Tersimpan.') : $slot); ?>

</div>
<?php /**PATH C:\laragon\www\Ngekos.in\resources\views/components/action-message.blade.php ENDPATH**/ ?>