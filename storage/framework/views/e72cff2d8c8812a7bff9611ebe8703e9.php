    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-sm ring-1 ring-gray-100">
            ...
            <p class="mt-2 text-sm text-gray-500">
                <?php echo e($exception?->getMessage() ?: 'Akun Anda tidak memiliki hak akses ke halaman ini.'); ?>
...
<?php /**PATH C:\laragon\www\Ngekos.in\resources\views\errors\403.blade.php ENDPATH**/ ?>