...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['rating' => 5, 'size' => 'h-4 w-4', 'interactive' => false, 'key' => '']));
...
foreach (array_filter((['rating' => 5, 'size' => 'h-4 w-4', 'interactive' => false, 'key' => '']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="flex items-center gap-0.5" <?php if($interactive): ?> x-data="{ nilai: <?php echo e($rating); ?>, hover: 0 }" <?php endif; ?>>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH C:\laragon\www\Ngekos.in\resources\views\components\star-rating.blade.php ENDPATH**/ ?>