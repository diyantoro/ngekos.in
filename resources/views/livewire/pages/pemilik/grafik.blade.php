        ...
        @if ($terkunci ?? false)
            ...
            @else
                <div class="max-w-2xl mx-auto">
                    <x-premium-lock requiredPlan="pro" title="Grafik & Analitik" message="Masa coba 7 hari sudah habis atau belum diklaim. Data tidak hilang, tapi halaman Laporan dikunci." />
                </div>
            @endif
        @else
